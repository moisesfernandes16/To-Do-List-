...
function showValues() {
    ...
    for (let i = 0; i < values.length; i++) {
        list.innerHTML += `<li><span>${values[i].name}</span><button id="btnOk" onclick='removeItem(${i})'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-lg" viewBox="0 0 16 16">
